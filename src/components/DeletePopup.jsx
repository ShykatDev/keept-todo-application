...
const DeletePopup = ({ confirmDelete, onClose }) => {
  return (
    <div className="bg-white dark:bg-black dark:bg-opacity-50 absolute min-w-[22rem] rounded-md bottom-10 right-10 p-4 text-neutral-700 dark:text-neutral-500 border border-neutral-400 dark:border-neutral-700 z-50">
